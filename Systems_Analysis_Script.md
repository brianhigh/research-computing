...
During the [Implementation](http://en.wikipedia.org/wiki/Implementation#Information_Technology_.28IT.29) 
...
Put another way, *project* scope defines the *work to be done* whereas 
